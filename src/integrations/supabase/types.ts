...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      tedarik_zinciri_submission_tracking: {
        Row: {
          id: number
          identifier: string
      ...
      tedarik_zinciri_tedarikci_basvuru: {
        Row: {
          created_at: string | null
          dokuman_url: string | null
          e_posta: string
        ...
        Relationships: [
          {
            foreignKeyName: "tedarik_zinciri_tedarikci_basvuru_urun_talep_id_fkey"
            columns: ["urun_talep_id"]
            isOneToOne: false
            referencedRelation: "tedarik_zinciri_urun_talep"
            referencedColumns: ["id"]
          },
        ]
      }
      tedarik_zinciri_urun_talep: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "tedarik_zinciri_urun_talep_on_talep_id_fkey"
            columns: ["on_talep_id"]
            isOneToOne: false
            referencedRelation: "tedarik_zinciri_on_talep"
            referencedColumns: ["id"]
          },
        ]
      }
