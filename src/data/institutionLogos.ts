...
export const institutionLogos: InstitutionLogo[] = [
  ...
  { id: "iskur", name: "İŞKUR (Türkiye İş Kurumu)", logoPath: "/img/instlogo/iskur.png", category: "employement" },
  { id: "bigg", name: "BİGG (Bireysel Genç Girişimci)", logoPath: "/img/image.png", category: "research&development" },
  {
    id: "kosgeb",
