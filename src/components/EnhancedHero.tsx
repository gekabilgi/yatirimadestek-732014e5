...
const EnhancedHero = () => {
  ...
  const [visibleNavItems, setVisibleNavItems] = useState([{ name: "Destek Arama", href: "/searchsupport" }]);
  ...
  return (
    <>
      ...
      <section
        ref={heroSectionRef}
        className="relative overflow-hidden bg-gradient-to-br from-primary/80 via-primary to-primary/90 min-h-[55vh] flex flex-col"
      >
            ...
            <div className="flex justify-between h-16 items-center">
              ...
              <div className="hidden lg:flex items-center space-x-2">
                {user && isAdmin ? (
                  ...
                  <Button variant="outline" onClick={() => navigate("/admin/login")} className="h-9 px-3 gap-2 text-sm">
                    <User className="h-4 w-4" />
                    <span>Giriş Yap</span>
                  </Button>
                )}
          ...
          <div className="mx-auto max-w-5xl w-full text-center space-y-8">
            ...
            <div className="animate-fade-in flex justify-center">
              <a
                ...
                className="inline-flex items-center gap-3 text-white/90 hover:text-white transition-colors align-center"
              >
                <Globe className="h-8 w-8 sm:h-10 sm:w-10 flex-shrink-0 translate-y-[2px]" strokeWidth={0.75} />
                <span className="text-2xl sm:text-3xl md:text-4xl font-thin content-center">yatirimadestek.gov.tr</span>
              </a>
            </div>
            ...
            <div className="animate-slide-up-delay-1">
              <p className="mx-auto max-w-3xl text-balance text-base sm:text-lg leading-relaxed text-white/90">
                İşletmeniz için en uygun teşvik ve destek programlarını keşfedin. Akıllı hesaplama araçlarımız ile
                potansiyel faydalarınızı öğrenin ve başvuru sürecinizi hızlandırın.
              </p>
            </div>
            ...
            <div className="animate-slide-up-delay-3 mt-12 sm:mt-16">
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 lg:gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs sm:text-sm font-medium text-white/80">Bugünkü Hesaplama</div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs sm:text-sm font-medium text-white/80">Bugünkü Arama</div>
                  <Badge className="bg-transparent border-0 text-xs text-blue-200 hover:bg-transparent">
