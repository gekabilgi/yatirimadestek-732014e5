          ...
          <Card className="bg-white shadow-sm border border-gray-200 rounded-lg">
            ...
            <CardContent className="space-y-8">
              ...
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">SGK Prim Oranları</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white rounded-2xl p-6 border-2 border-gray-300 shadow-sm">
                    <div className="text-center mb-6">
                      <div className="bg-gray-100 rounded-full px-6 py-2 inline-block border border-gray-300">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-3">
                        <div className="bg-gray-100 rounded-full px-4 py-2 text-center border border-gray-300">
                          <Label className="text-sm font-medium text-gray-700">
                            İmalat
                          </Label>
                        </div>
                        <div className="bg-gray-100 rounded-2xl border-2 border-gray-300 p-4">
                          <Input
                            type="number"
                            step="0.01"
