          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2">
                Tedarikçi Fırsatları
              </h1>
              <p className="text-xl opacity-90">
                Büyük firmalardan gelen ürün ve hizmet taleplerini inceleyin, başvuru yapın
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Aşağıdaki firmalar sizin ürün/hizmetlerinize ihtiyaç duyuyor. Detayları inceleyip başvuru yapabilirsiniz.
          </p>
        </div>
        ...
        {companies.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Yeni talepler eklendiğinde burada görüntülenecektir.
            </p>
          </div>
        ) : (
