        ...
        <div className="mb-6">
          <Card className="card-elevated border-0 animate-fade-in">
            <CardHeader className="pb-3 pt-3 px-4 sm:px-6">
              <CardTitle className="text-center text-xl sm:text-2xl lg:text-3xl font-bold">Teşvik Araçları</CardTitle>
                ...
                {activeModule === 'query' && (
                  <div>
                    <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 mb-6 sm:mb-8 justify-center text-center">
                      ...
                      <h2 className="text-lg sm:text-xl lg:text-2xl font-bold">Yüksek Teknoloji, Orta-Yüksek Teknoloji, Hedef Sektörler, Öncelikli Sektörler Teşvik Sorgusu</h2>
                    </div>
                ...
                {activeModule === 'calculator' && (
                  <div>
                    <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 mb-6 sm:mb-8 justify-center text-center">
                      ...
                      <h2 className="text-lg sm:text-xl lg:text-2xl font-bold">Teknoloji Hamlesi, Yerel Kalkınma Hamlesi ve Stratejik Hamle Kapsamında Teşvik Hesaplama</h2>
                    </div>
