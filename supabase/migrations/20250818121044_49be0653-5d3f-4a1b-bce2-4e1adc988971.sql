-- Drop the view that's causing security issues and create a secure function instead
...
-- Revoke any previous grants on the dropped view
REVOKE ALL ON public.approved_pre_requests FROM anon, authenticated;